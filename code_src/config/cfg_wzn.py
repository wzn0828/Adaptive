...
# optimization
# CNN fine-tuning
opt_fine_tune_cnn_start_layer   = 0                                         # CNN fine-tuning layers from: [0-7]
...
opt_rnn_sgd_learning_rate           = 5e-6
opt_rnn_sgd_momentum                = 0.9

# Optimizer parameter of cnn
opt_cnn_optimization            = 'sgd'  #['adam','sgd']
opt_cnn_adam_alpha              = 0.8                                       # alpha in Adam
opt_cnn_adam_beta               = 0.999
opt_cnn_adam_learning_rate      = 1e-6

opt_cnn_sgd_learning_rate       = 1e-6
opt_cnn_sgd_momentum            = 0.9
